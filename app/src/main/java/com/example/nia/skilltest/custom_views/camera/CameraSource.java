...
@SuppressWarnings("deprecation") public class CameraSource {
    ...
    public void stop() {
        synchronized (mCameraLock) {
            if (mDetector != null) mFrameProcessor.setActive(false);
    ...
    @SuppressLint("InlinedApi") private Camera createCamera() {
        ...
        if (requestedCameraId == -1) {
            mFacing = getIdForRequestedCamera(CAMERA_FACING_BACK);
    ...
    private class CameraPreviewCallback implements Camera.PreviewCallback {
        @Override public void onPreviewFrame(byte[] data, Camera camera) {
            if (mDetector != null) mFrameProcessor.setNextFrame(data, camera);
        }
    }
